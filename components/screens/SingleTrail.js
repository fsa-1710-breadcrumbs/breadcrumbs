...
class SingleTrail extends React.Component {
  ...
  _onGLContextCreate = async (gl) => {
    ...
    sphere.position.z = trailToDisplay[0].z-0.015;
    scene.add(sphere);
    ...
    for (let i = 1; i <= trailToDisplay.length - 2; i++){
      ...
      sphereMid.position.y = trailToDisplay[i].y-0.44;
    ...
    sphere3.position.y = trailToDisplay[trailToDisplay.length - 1].y-0.44;
